#include "drake/multibody/parsers/sdformat_parser.h"
...
bool ParseSdfGeometry(XMLElement* node, const PackageMap& package_map,
  ...
  if ((shape_node = node->FirstChildElement("box"))) {
    ...
    cerr << string(__FILE__) + ": " + __func__ + ": WARNING: "
...
ModelInstanceIdTable AddModelInstancesFromSdfFileToWorld(
  ...
  return AddModelInstancesFromSdfFile(filename, floating_base_type, nullptr, tree);
}
